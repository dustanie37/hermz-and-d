...
function StatCard({ value, label, sub, accent = 'text-white' }) {
  return (
    <div className="card px-5 py-4">
      ...
      {sub && <p className="font-serif italic text-xs text-gray-500 mt-1">{sub}</p>}
    </div>
  )
}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                <div className="card p-5">
                  ...
                  <ul>
                    ...
                    {risers.length === 0 && <p className="font-serif italic text-sm text-gray-500">No risers this time.</p>}
                  </ul>
                </div>
                <div className="card p-5">
                  ...
                  <ul>
                    ...
                    {fallers.length === 0 && <p className="font-serif italic text-sm text-gray-500">Nothing fell — generous mood.</p>}
                  </ul>
                </div>
              </div>
            )}
              ...
              <div className="card p-5">
                ...
                <ul>
                  ...
                  {newEntries.length === 0 && returning.length === 0 && (
                    <p className="font-serif italic text-sm text-gray-500">Every film has ranked before.</p>
                  )}
                </ul>
              </div>
              <div className="card p-5">
                ...
                <ul>
                  ...
                  {dropped.length === 0 && (
                    <p className="font-serif italic text-sm text-gray-500">Nothing dropped — the canon holds.</p>
                  )}
                </ul>
              </div>
            </div>
