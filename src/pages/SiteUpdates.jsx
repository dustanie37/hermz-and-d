...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { tag: 'Podcast', color: 'cinema', isNew: true, name: 'Deep Dives',
      ...
      { tag: 'Podcast', color: 'cinema', isNew: true, name: 'Recording view',
      ...
      { tag: 'Podcast', color: 'cinema', isNew: true, name: 'Feature library',
